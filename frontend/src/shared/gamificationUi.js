  ...
  switch (tierKey) {
    case "bronze":
      return {
        ...
        panelClassName:
          "border-[#6B4A33] bg-[radial-gradient(circle_at_top,_rgba(180,112,73,0.24),_transparent_58%),linear-gradient(180deg,#17110E_0%,var(--surface-secondary)_100%)]",
    ...
    case "silver":
      return {
        ...
        panelClassName:
          "border-[#5A6C80] bg-[radial-gradient(circle_at_top,_rgba(167,186,205,0.22),_transparent_58%),linear-gradient(180deg,#141922_0%,var(--surface-secondary)_100%)]",
    ...
    case "gold":
      return {
        ...
        panelClassName:
          "border-[#8B6A18] bg-[radial-gradient(circle_at_top,_rgba(245,158,11,0.24),_transparent_58%),linear-gradient(180deg,#17130A_0%,var(--surface-secondary)_100%)]",
    ...
    case "platinum":
      return {
        ...
        panelClassName:
          "border-[#1D6C79] bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.24),_transparent_58%),linear-gradient(180deg,#101A1F_0%,var(--surface-secondary)_100%)]",
    ...
    case "legend":
      return {
        ...
        panelClassName:
          "border-[#7C3AED] bg-[radial-gradient(circle_at_top,_rgba(124,58,237,0.26),_transparent_58%),linear-gradient(180deg,#171024_0%,var(--surface-secondary)_100%)]",
    ...
    default:
      return {
        ...
        panelClassName:
          "border-[#1F6A55] bg-[radial-gradient(circle_at_top,_rgba(1,187,150,0.18),_transparent_58%),linear-gradient(180deg,#141922_0%,var(--surface-secondary)_100%)]",
        accentClassName: "text-[#A7F3D0]",
        progressClassName:
          "bg-[linear-gradient(90deg,var(--accent-primary)_0%,#7DD3FC_100%)]",
      };
  }
}
  ...
  switch (rarityKey) {
    case "rare":
      return {
        ...
        glowClassName: "from-[#102C40] to-[var(--surface-secondary)]",
      };
    case "epic":
      return {
        labelClassName: "bg-[#2A1745] text-[#D6B4FF]",
        ringClassName: "border-[#6941C6]",
        glowClassName: "from-[#2A1745] to-[var(--surface-secondary)]",
      };
    case "legendary":
      return {
        labelClassName: "bg-[#3B290D] text-[#FFD37A]",
        ringClassName: "border-[#F59E0B]",
        glowClassName: "from-[#3B290D] to-[var(--surface-secondary)]",
      };
    case "common":
    default:
      return {
        labelClassName: "bg-[#1A1F2A] text-[#B9C1CF]",
        ringClassName: "border-[var(--border-primary)]",
        glowClassName: "from-[#141922] to-[var(--surface-secondary)]",
      };
  }
}

export function getAchievementDifficultyMeta(difficultyKey) {
  switch (difficultyKey) {
    case "medium":
      return {
        label: "Средние",
        badgeClassName: "bg-[#3A2C10] text-[#F6D27D]",
        ringClassName: "border-[#8B6A18]",
      };
    case "hard":
      return {
        label: "Сложные",
        badgeClassName: "bg-[#2A1745] text-[#D6B4FF]",
        ringClassName: "border-[#6941C6]",
      };
    case "easy":
    default:
